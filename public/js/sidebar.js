    ...
    const sidebarHTML = `
        ...
        <aside id="sidebar" class="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col fixed h-full z-40 transition-transform duration-300 -translate-x-full md:translate-x-0">
            ...
            <nav class="flex-1 px-4 space-y-2 mt-4">
                ...
                <a class="flex items-center gap-3 px-4 py-3 rounded-full ${activePage === 'charAnalysis' ? 'bg-primary/20 text-slate-900 dark:text-white active-fill' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors'}"
                    href="vietnamese-to-chinese-analysis.html">
